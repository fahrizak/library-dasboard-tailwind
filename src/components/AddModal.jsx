...
const UpdateModal = () => {
    ...
    return (
        <>
            <div onClick={toggleModal} className=" bg-[#0270AF] hover:bg-[#078AE9] px-5 py-2 mb-4 flex items-center gap-2 rounded-lg text-white cursor-pointer">
            ...
            {modal && (
                <div className="fixed inset-0 z-50 grid place-items-center">
                    ...
                    <div className=" absolute lg:w-[510px] bg-white px-7 py-3.5 rounded-lg w-[300px] grid z-50">
                        <h2 className=" text-black mb-6 cursor-pointer text-2xl">Tambah Data Buku</h2>
                        ...
                        <div>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className=" form-button flex justify-between mt-4">
                                    <div onClick={toggleModal} className=" px-4 py-2 rounded-lg shadow-md text-[#0270AF] font-semibold cursor-pointer">Batalkan</div>
                                    <button type="submit" style={{ backgroundColor: isFormValid() ? '#0270AF' : 'lightgray' }} className="border-0 px-4 py-2 rounded-lg shadow-md text-white bg-[#0270AF] font-semibold">Tambah</button>
                                </div>
